...
const codapInterface = {
  ...
  init (iConfig: IConfig, iCallback?: (arg0: any) => void) {
    ...
    return new Promise(function (resolve: (arg0: any) => void, reject: { (arg0: string): void; (arg0: any): void; }) {
      function getFrameRespHandler(resp: { values: { error: any; savedState: any }; success: boolean }[]) {
        ...
        const savedState = receivedFrame !== false ? receivedFrame.savedState : undefined;
  ...
  sendRequest (message: any, callback?: any) {
    ...
    return new Promise(function (resolve, reject) {
      function handleResponse(
        ...
        callback2: (arg0: any, arg1: any) => void) {
   ...
   */
  createSubscriber (actionSpec: string, resourceSpec: string,
                              operation: string | (() => void), handler?: (...args2: any) => void): Subscriber {
    let as = "notify",
      os;
  ...
  on (actionSpec: string, resourceSpec: string,
